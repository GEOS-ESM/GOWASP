   ...
   real(4) :: data(7,nrmax), dataBKG(7,nrmax), datadiff(7)
   real(4) :: omf(2,nbins)
...
!   open (93,file='/discover/home/rerrico/GOWASP_3/GPSROTEST/xxgg45.txt',form='unformatted')
   open (93,file='/discover/nobackup/rerrico/TEST_GPS_517/allNR0p.txt',form='unformatted')
...
!       datadiff(5)=data(4,n)-data(5,n)    ! ROPP_NR-GSI_NR
       datadiff(5)=dataBKG(4,nf)-dataBKG(5,nf)    ! ROPP_BKG-GSI_NBKG
