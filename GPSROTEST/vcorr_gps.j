...
#
set exp="517osse"
set exp_dir="${exp}TEST"
set ods_name="${exp}.diag_conv."    # "${exp}.diag_conv."
set omf="omf"                       # omf, oma, amb, or obs 

set ods_path="/discover/nobackup/rerrico/ODSfiles/${exp_dir}"         # path to ODS files
setenv OUTPUT /discover/nobackup/rerrico/ODSstats/${exp_dir}/Vcorr_1day # output dir 
...
set datetime1="2006071100"  # starting datetime yyyymmddhh                   &&
set addhours="+12"     # hours between times to consider                    &&
@ ntimes =  1             # number of synoptic times to process          &
...
setenv RESTART_DIR /discover/nobackup/rerrico/ODSstats/${exp_dir}/Vcorr_1day/Save_sums
