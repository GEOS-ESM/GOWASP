...
#-------------------------
  ...
  setenv SIMPARAMS  $RC_FILES/ErrParams/V04.5   # dir for error parameters
  setenv Err_file   error.V04.5.rc            # file in dir $SIMPARAMS
...
#
  set BF_path_input="/discover/nobackup/projects/gmao/nwposse/develop/OSSEobs/N010"
#  set BF_path_input="/discover/nobackup/rerrico/OSSEobs/N010"
...
#---------------------------------------
#
set datetime1="2006102000"   # set initial symoptic date time


@ ntimes = 44

# set which error data sets to create
#set instr_set=( GPSRO AIRS AMSUAAQUA AMSUA  IASI ATMS SSMIS  HIRS4)
