...
#-------------------------
  ...
  setenv SIMPARAMS  $RC_FILES/ErrParams/V04.3  # dir for error parameters
  setenv Err_file   error.V04.3.rc           # file in dir $SIMPARAMS
...
#---------------------------------------
#
set datetime1="2006102600"   # set initial symoptic date time
