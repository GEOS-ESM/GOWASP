...
#
  setenv RC_FILE    $GOWASP_PATH/Rcfiles/field_list_gpsro.rc # file
  setenv BUFR_IN    /discover/nobackup/projects/gmao/nwposse/develop/BUFRDATA  # dir for real BUFR for obs 
  setenv BUFR_OUT   /discover/nobackup/projects/gmao/nwposse/develop/OSSEobs/N010    # dir for BUFR output             
#                                                                               
set datetimeN=2006102300  # starting time for nr field data                     
set datetimeB=2020102300  # starting time for real obs data bufr files          
@ ntimes =    44           # number of times to process                          
