...
echo "NBRPROCS = ${NBRPROCS}"
  ...
  setenv SIMHOME    $GOWASP_PATH/Sim_gpsro  # dir for some files/executables
...
#
  setenv RC_FILE    $GOWASP_PATH/Rcfiles/field_list_gpsro_gsi.rc # file
  setenv BUFR_IN    /discover/nobackup/projects/gmao/nwposse/OSSEobs/EGPS529/GPSRO  # dir for real BUFR for obs 
  setenv BUFR_OUT   /discover/nobackup/projects/gmao/nwposse/OSSEobs/GPSGSI    # dir for BUFR output             
#                                                                               
set datetimeN=2006070800  # starting time for nr field data                     
set datetimeB=2006070800  # starting time for real obs data bufr files          
@ ntimes =    40           # number of times to process                          
...
cp $SIMHOME/create_gpsro.x prog.x
