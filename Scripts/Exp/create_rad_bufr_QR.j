#!/bin/csh -xf 
#SBATCH --job-name=SIMRADBQR
#SBATCH --time=11:59:00 
#SBATCH --nodes=1   --constraint=cas 
#SBATCH --output=SIMRADBQR.%j 
...
# drawn from obs BUFR files for ingestion into create_rad_profs 
  ...
  setenv RC_FILE    $GOWASP_PATH/Rcfiles/rad_prob_N010_QR.rc  # rc file 
...
#  setenv BUFR_IN    $GOWASP_BUFR_DATA  # dir for real BUFR data to get buf tabl
  setenv BUFR_IN    /discover/nobackup/projects/gmao/nwposse/develop/BUFRDATA/ 
  setenv PROF_IN    /discover/nobackup/projects/gmao/nwposse/develop/OSSEobs/N010/ObsProf
  setenv BUFR_OUT   /discover/nobackup/projects/gmao/nwposse/develop/OSSEobs/N010   # dir for BUFR output
  setenv CLEAR_SKY  _clear.bin # none or filename suffix if all-sky but clear-sky Tb also witten 
...
#
set datetimeN=2006102900  # starting time to process
set datetimeB=2020102900  # set as explained above
@ ntimes =    12            # number of times to process

# set which radiance data sets to create
#set instr_set= (MHS GMI AMSR2)
set instr_set= (AMSR2 GMI  MHS)
