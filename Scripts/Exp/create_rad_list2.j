...
set datetimeN=2006082600  # starting time for NR           
set datetimeB=2019082600  # starting time for BUFR data    
@ ntimes = 24          # number of times to process                              
#   
# set which radiance data sets to create 
# GMI must be done separately as long as the dates differ (must use after 2014) 
#set instr_set= (AIRS AMSUAAQUA AMSUA HIRS4 MHS IASI ATMS GMI SSMIS CRISFSR  AMSR2)
set instr_set= (AMSR2)
