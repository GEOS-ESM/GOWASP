...
# 
  ...
  setenv OUTPUT     /discover/nobackup/projects/gmao/obsdev/mkim/OSSEobs/N010/ObsProf # dir for output
#
...
#set instr_set= (AIRS AMSUAAQUA CRISFSR AMSUA HIRS4 IASI ATMS MHS GMI SSMIS  AMSR2)
