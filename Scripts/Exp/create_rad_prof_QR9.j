...
#
  ...
  setenv OUTPUT     /discover/nobackup/projects/gmao/nwposse/develop/OSSEobs/N010/ObsProf_QR # dir for output

#
set datetimeN=2006092500 # starting time to process
@ ntimes =   32           # number of times to process
