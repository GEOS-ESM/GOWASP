...
!  ---------------------------------------------
   ...
   real(rkind1), pointer :: fld_s1t2(:,:)  => null()  ! u2m or t2m at t2
...
!
   ...
   call MAPL_DeallocNodeArray(fld_s1t2,rc=ierr)
...
! ****************************************
!
   subroutine getdat (xind, yind, dat1, dat2)
!
!
   use m_parameters, only : grav
!
...
!
   ...
   real(rkind1), intent(out) :: dat1, dat2
!
   dat1 = fld_pst1(xind,yind)
   dat2 = fld_pst2(xind,yind)
!
!
