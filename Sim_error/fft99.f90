...
!-----------------------------------------------------------------------
!
! Original code from Clive Temperton circa 1981
! $Id: fft99.f90,v 1.1 2013-09-03 21:45:32 rerrico Exp $
! $Author: rerrico $
!
      implicit none
      integer, parameter :: rkind_fft=8
      INTEGER  :: IFAX(13),INC,JUMP,N,LOT,ISIGN
      REAL(rkind_fft) :: A(LOT*(N+2)),WORK(LOT*(N+1)), TRIGS(3*N/2+1)
