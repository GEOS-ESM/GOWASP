...
!
   integer, parameter :: obs_data_max=25001   ! max # of multi-lev reports
...
!
   use m_nr_fields_info, only : field_gpsro_algorithm
...
! Also, if field_gpsro_algorithm > 0  then GPSRO algorithm  will be 1d.
   ierr_azim=0
   do i=1,ilevs
   ...
   enddo
   if (ierr_azim > ilevs/3 .or. field_gpsro_algorithm > 0) then 
