...
set exp="real529"
set exp_dir=$exp                         
set ods_path="/discover/nobackup/projects/gmao/nwposse/baselineruns/${exp_dir}/odsfiles" 
#set exp="ctl529"
#set exp_dir=$exp                         
...
set datetime1="2020070100"  # starting datetime yyyymmddhh                   
@ ntimes_other =  124      # number of synoptic times to process            
@ ntimes_raobs =  62     # number of synoptic times to process for raobs  

# Set the output directory
setenv OUTPUT /discover/nobackup/projects/gmao/nwposse/develop/ODSstats/${exp_dir}/Counts_conv_July

# Set kx values to process (=89 for GPSRO) 
set kx_set= (120 130 131 132 133 180 181 182 187 220 221 223 224 229 230 231 232 233 242 243 245 246 250 252 253 254 257 258 259 280 282 290 )
