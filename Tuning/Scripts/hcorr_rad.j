...
#set region="GLOB"           # geo region to compute correls (see below)      
 set region="GLOB"     # for hyperspectral
...
set kx_set= (amsua_n15 amsua_n18 amsua_n19 amsua_metop-a amsua_metop-b hirs4_metop-a hirs4_n18 mhs_metop-a mhs_metop-b cris-fsr_n20 cris-fsr_npp atms_npp atms_n20 ssmis_f17 amsr2_gcom-w1 avhrr_metop-a avhrr_n18 avhrr_n19 gmi_gpm)
