...
set sat_info_file=/discover/home/rerrico/Amal/sat_info.rc
#
...
set datetime1="2006062000"  # starting datetime yyyymmddhh                   
@ ntimes =   20          # number of synoptic times to process            

# Set the output directory
setenv OUTPUT /discover/nobackup/rerrico/ODSstats/${exp_dir}/Counts_rad_June

# Set instr_platform for obs types to process
set kx_set= (hirs2_n07 hirs2_n08 msu_n07 msu_n08)
