...
set datetime1="2015070100"  # starting datetime yyyymmddhh                   
@ ntimes =    2              # number of synoptic times to process            
set region="GLOB"           # geo region to compute statistics (see below) 

# Set the output directory
setenv OUTPUT /discover/nobackup/rerrico/ODSstats/Test
...
setenv RESTART_DIR /discover/nobackup/rerrico/ODSstats/Test
setenv RESTART_I 0  # set to 0 unless this is a restart

# Set instr_platform for .ods files to process
set kx_set= (airs_aqua)    # (cris_npp airs_aqua iasi_metop-a iasi_metop-b)
